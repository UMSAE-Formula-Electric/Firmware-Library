...
/* HeartBeats */
#define CAN_ACU_TO_VCU_ID           0x016 // Dec: 22 (Fixed from 0x002)
#define CAN_VCU_TO_ACU_ID           0x017 // Dec: 23 (Fixed from 0x003)
#define CAN_VCU_SET_ACB_STATE_ID	0x015 // Dec: 21 (Fixed from 0x01)
